    ...
    public partial class mig04 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonChildId = table.Column<int>(type: "int", nullable: false),
                    RelationshipDescription = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PersonParentId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonPerson", x => new { x.PersonChildId, x.PersonParentId, x.RelationshipDescription });
                    table.ForeignKey(
                        name: "FK_PersonPerson_Person_PersonChildId",
                        column: x => x.PersonChildId,
                        principalTable: "Person",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PersonPerson_Person_PersonParentId",
                        column: x => x.PersonParentId,
                        principalTable: "Person",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonPerson_PersonChildId_PersonParentId",
                table: "PersonPerson",
                columns: new[] { "PersonChildId", "PersonParentId" });

            migrationBuilder.CreateIndex(
                name: "IX_PersonPerson_PersonChildId_PersonParentId_RelationshipDescription",
                table: "PersonPerson",
                columns: new[] { "PersonChildId", "PersonParentId", "RelationshipDescription" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PersonPerson_PersonParentId",
                table: "PersonPerson",
                column: "PersonParentId");
